...
public class Block extends AbstractBlock implements IItemProvider, net.minecraftforge.common.extensions.IForgeBlock {
    ...
    public static List<ItemStack> getDrops(BlockState blockstate, ServerWorld p_220070_1_, BlockPos p_220070_2_, @Nullable TileEntity p_220070_3_) {
    ...
    public static void dropResources(BlockState blockstate, World world, BlockPos pos) {
        if (world instanceof ServerWorld) {
            getDrops(blockstate, (ServerWorld)world, pos, (TileEntity)null).forEach((itemstack) -> {
                popResource(world, pos, itemstack);
            });
            blockstate.spawnAfterBreak((ServerWorld)world, pos, ItemStack.EMPTY);
        }

    }

    public static void dropResources(BlockState blockstate, IWorld world, BlockPos pos, @Nullable TileEntity te) {
        if (world instanceof ServerWorld) {
            getDrops(blockstate, (ServerWorld)world, pos, te).forEach((itemstack) -> {
    ...
    public static void dropResources(BlockState blockstate, World world, BlockPos pos, @Nullable TileEntity te, Entity entity, ItemStack p_220054_5_) {
        if (world instanceof ServerWorld) {
            getDrops(blockstate, (ServerWorld)world, pos, te, entity, p_220054_5_).forEach((itemstack) -> {
                popResource(world, pos, itemstack);
            });
            blockstate.spawnAfterBreak((ServerWorld)world, pos, p_220054_5_);
        }

    }

    public static void popResource(World world, BlockPos pos, ItemStack itemStack) {
